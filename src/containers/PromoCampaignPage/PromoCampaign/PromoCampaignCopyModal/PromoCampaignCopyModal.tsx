...
type PromoCampaignCopyModalProps = {
    promoCampaignData: PromoCampaignDto;
    children: ReactElement;
};

const PromoCampaignCopyModal: React.FC<PromoCampaignCopyModalProps> = ({
    promoCampaignData,
    children,
}) => {
...
(PromoCampaignCopyModal as any).propTypes = {
