...
import { DIRECTION } from '../../containers/GroupsPage/GroupList/groupListConstants';
...
const HeaderWithActions = ({
    ...
    const [paramsSync, setParamsSync] = useState(getSearchParamsFromUrl(search));
    ...
    const setAsyncParams = useCallback((searchParams = defaultPaginationParams) => {
        if (loading) {
            return;
        }
    ...
    const setSyncParams = useCallback((searchParams = defaultSearchParams) => {
        ...
        <div className={ styles.wrapper }>
            ...
            <div className={ styles.actions }>
                <div className={ styles.buttons }>
                    <ButtonsBlock buttons={ buttons } params={ currentParams } />
                    { showSearchInput && (
