...
test('valid url test', () => {
    ...
    expect(validateURL('hTTps://www.sberbank.ru')).toBe(true);
    expect(validateURL('http://www.sbarbank.ru')).toBe(true);
    expect(validateURL('http://www.sbarbDnk.Ru')).toBe(true);
    expect(validateURL('HTTP://WWW.SBERBANK.RU')).toBe(true);
    ...
    expect(validateURL('http://promo.sberhealth.ru/vvo')).toBe(true);
    expect(validateURL('http://promo.sberhealth.ru/vVo')).toBe(true);
    ...
    expect(validateURL('http://promo.sberhealth.ru/vVo/teSSS')).toBe(true);
    expect(validateURL('http://promo.sberhealth.ru/?vvo')).toBe(true);
    expect(validateURL('http://promo.sberhealth.ru?vvo')).toBe(true);
    expect(validateURL('http://promo-test878.sberhealth.ru?vvo')).toBe(true);
    expect(validateURL('http://4444.sberhealth.ru?vvo')).toBe(true);
    expect(validateURL('http://4444.sberhealth.co.uk?vvo')).toBe(true);
    expect(validateURL('http://test.co.uk?vvo')).toBe(true);
    expect(validateURL('http://3423.co.uk?vvo')).toBe(true);
    expect(validateURL('3423.co.uk?vvo')).toBe(true);
    expect(validateURL('xn--80abap1arsf.xn--p1ai')).toBe(true);
    expect(validateURL('http://xn--80abap1arsf.xn--p1ai')).toBe(true);
    expect(validateURL('xn--80abap1arsf.ru')).toBe(true);
    expect(validateURL('http://тест.домен.рф?vvo')).toBe(true);
    expect(validateURL('http://тест.домен.рф?ДАнные')).toBe(true);
    expect(validateURL('http://тTст.дJBен.рф?ДАнные')).toBe(true);
    expect(validateURL('http://тест.домен.рф?тест=test')).toBe(true);
    expect(validateURL('http://тест.домен.рф/?тест=test')).toBe(true);
    ...
    expect(validateURL('https://sberbank.ru#source=vitrina.sber.ru&offer_client={http://tест.домен.рф?vvo}')).toBe(true);
    expect(validateURL('https://sberbank.ru/source=vitrina.sber.ru&offer_client={http://tест.домен.рф#vvo}')).toBe(true);
    expect(validateURL('http://okko.tv/?utm_source=sberbank&utm_medium=finance_promo&utm_campaign=vitrina.vsp/{PHONE_NUMBER_HASH}#promo-code/{PROMO_CODE}')).toBe(true);
